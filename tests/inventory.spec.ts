...
test.describe("Inventory Page", () => {
    ...
    test("Should display total 6 inventory items", async ({ authenticatedPage }) => {
    ...
    test("Should add and remove product from cart", async ({ authenticatedPage }) => {
        const productName: string = "Sauce Labs Backpack";
    ...
    test("Should sort by price low to high", async ({ authenticatedPage }) => {
